...
function boost(modifier, target, maxUnitCost) {
  ...
  try {
    for (_iterator.s(); !(_step = _iterator.n()).done;) {
      ...
      if (modifier === "Cold Resistance" && turnsAvailable() < (0,src_lib/* remainingTurns */.bg)()) continue;
...
function expectedHp(weight) {
  ...
  return 1.1 * (0.05 * Math.pow(weight - 5, 4) + 100);
}
  ...
  try {
    ...
    while ((0,src_lib/* remainingTurns */.bg)() > 0 && (0,external_kolmafia_.myAdventures)() > 0) {
      ...
      do {
        ...
        madeProgress = false;
        (0,external_kolmafia_.print)("madeProgress: ".concat(madeProgress));
      ...
      (0,external_kolmafia_.print)("Boosting Cold Res (and possibly Item Drop).", "blue");
