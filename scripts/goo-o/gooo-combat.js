...
/* harmony export */ });
/* unused harmony exports coldRes, currentTurnsSpent, currentTurnsSpentForColdRes, todayTurnsSpent, todayTurnsSpentForColdRes, totalTurnsToday, remainingTurns, incrementTurnsSpentAdjustment, turnsSpentAdjustment, expectedHp, lanternMultiplier, predictedDamage */
/* harmony import */ var kolmafia__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(7530);
/* harmony import */ var kolmafia__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(kolmafia__WEBPACK_IMPORTED_MODULE_0__);
...
function coldRes() {
  if (have($effect(_templateObject || (_templateObject = _taggedTemplateLiteral(["Entauntauned"])))) && get("entauntaunedColdRes", 0) === 0) {
    visitUrl("desc_effect.php?whicheffect=".concat($effect(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["Entauntauned"]))).descid));
  }
